...
public class namever {
    ...
    boolean emtuname(String s) throws emptyUnameException {// the username shouldn't be empty
        String st = null;
        String st1 = "";
    ...
    boolean lenuname(String s) throws LongUsernameException {// the username shouldn't be more than 20
        if (s.length() > 20) {
    ...
    boolean specialCharacter(String s) throws specialcharusername {// there can't be any special character except the
                                                                   // underscore
    ...
    public boolean namego(String a) throws IOException {
